...
ActiveRecord::Schema.define(version: 20150108100704) do
  ...
  add_index "collaborations", ["page_id"], name: "index_collaborations_on_page_id"
  ...
  add_index "todoos", ["user_id"], name: "index_todoos_on_user_id"
